...
/***/ function(module, exports, __webpack_require__) {
	...
	var _swiperMin = __webpack_require__(159);
	...
	var SwiperWrapper = function (_Component) {
	    _inherits(SwiperWrapper, _Component);

	    function SwiperWrapper(props) {
	        _classCallCheck(this, SwiperWrapper);

	        var _this = _possibleConstructorReturn(this, (SwiperWrapper.__proto__ || Object.getPrototypeOf(SwiperWrapper)).call(this, props));
	    ...
	    _createClass(SwiperWrapper, [{
	        key: 'componentDidMount',
	        value: function componentDidMount() {
	            this.swiper = new _swiperMin2.default('.swiper-container.swiper-container-' + this.name, {
	        ...
	        value: function render() {
	            var slides = _react2.default.Children.map(this.props.children, function (child, index) {
	                return _react2.default.createElement(
	                    'div',
	                    { className: 'swiper-slide', key: 'slider-' + index },
	                    child
	                );
	            });
	            return _react2.default.createElement(
	                'div',
	                { className: '' + this.props.customClassName, style: { width: this.props.width } },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'swiper-container swiper-container-' + this.name },
	                    _react2.default.createElement(
	                        'div',
	                ...
	                _react2.default.createElement('div', { className: 'swiper-button-prev swiper-prev-' + this.name }),
	                _react2.default.createElement('div', { className: 'swiper-button-next swiper-next-' + this.name })
	            );
	        }
	    }]);
	...
	var KmcSlideTable = function (_Component2) {
	    _inherits(KmcSlideTable, _Component2);

	    function KmcSlideTable(props) {
	        _classCallCheck(this, KmcSlideTable);

	        var _this2 = _possibleConstructorReturn(this, (KmcSlideTable.__proto__ || Object.getPrototypeOf(KmcSlideTable)).call(this, props));

	        _this2.name = (Math.random() * 100000000).toString().substr(0, 5);
	        return _this2;
	    }

	    _createClass(KmcSlideTable, [{
	        key: 'render',
	        value: function render() {
	            var _props = this.props,
	                ...
	                slideable = _props.slideable;

	            var dataColumnWidth = 1 / columnNum * 100 + '%';
	            var headerColumnWidth = headerWidth.replace(/$|%$/, '%');
	            var sliderWidth = 100 - parseFloat(headerWidth.replace('%', '')) + '%';
	            var tableHeader = header.map(function (title, index) {
	                return _react2.default.createElement(
	                    'ul',
	                    { className: 'table-header', key: 'title-' + index },
	                    _react2.default.createElement(
	                        'li',
	                        { className: 'title-text', key: 'title-' + index },
	                        title.key
	                    )
	                );
	            });
	            var tableColumn = data.map(function (info, index) {
	                return _react2.default.createElement(
	                    'ul',
	                    { className: 'column-container', style: { width: dataColumnWidth }, key: 'column-' + index },
	                    header.map(function (title, index) {
	                        return _react2.default.createElement(
	                            'li',
	                            { className: 'row-text', key: 'row-' + index },
	                            info[title.value] || defaultValue
	                        );
	                    })
	                );
	            });
	            ...
	            for (var i = 0; i < tableColumn.length; i++) {
	                ...
	                if ((i + 1) % columnNum === 0 || i + 1 === tableColumn.length) {
	                    sliders.push(_react2.default.createElement(
	                        'div',
	                        { className: 'table-slider', key: 'slider-' + sliderIndex++ },
	                        slider
	                    ));
	                    slider = [];
	                }
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'header-container', style: { width: headerColumnWidth } },
	                        tableHeader
	                    ),
	                    _react2.default.createElement(
	                        SwiperWrapper,
	                        { name: this.name, slideable: slideable, width: sliderWidth, customClassName: 'slider-container' },
	                        sliders
	                    )
	                )
	            );
	...
	KmcSlideTable.propTypes = {
	    ...
	    header: _react.PropTypes.array.isRequired, // 表格标题
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../../css-loader/index.js!../../../postcss-loader/index.js!../../../less-loader/index.js!./swiper.css", function() {
				var newContent = require("!!../../../css-loader/index.js!../../../postcss-loader/index.js!../../../less-loader/index.js!./swiper.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
