...
/***/ function(module, exports, __webpack_require__) {
	...
	var _SwiperWrapper = __webpack_require__(159);

	var _SwiperWrapper2 = _interopRequireDefault(_SwiperWrapper);
	...
	var SlideTable = function (_Component) {
	    ...
	    _createClass(SlideTable, [{
	        ...
	        value: function render() {
	            ...
	            var tableHeader = header.map(function (ttl, index) {
	            ...
	            var tableColumn = data.map(function (info, index) {
	                return _react2.default.createElement(
	                    ...
	                    header.map(function (ttl, i) {
	                        return _react2.default.createElement(
	                            'li',
	                            { className: 'row-text', key: 'row-' + i },
	                            info[ttl.value] || defaultValue
	                        );
	                    })
	                );
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _swiper = __webpack_require__(160);
	...
	var SwiperWrapper = function (_Component) {
	    ...
	    _createClass(SwiperWrapper, [{
	        ...
	        value: function componentDidMount() {
	            this.swiper = new _swiper2.default('.swiper-container.swiper-container-' + this.name, {
	...
	SwiperWrapper.propTypes = {
	    ...
	    slideable: _react.PropTypes.bool.isRequired,
	    width: _react.PropTypes.string.isRequired,
	    customClassName: _react.PropTypes.string.isRequired,
	    children: _react.PropTypes.node.isRequired
	};

	exports.default = SwiperWrapper;
